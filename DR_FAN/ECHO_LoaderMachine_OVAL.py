...
from modulator_FAN_OVAL import build_circulant_matrix
from Phantom_generator_FAN_OVAL import perform_scan_on_phantoms
from CGAN_paper_ECHO_FAN_OVAL import Generator
import psutil, time
...
# Load model
generator_model_path = "Outputs\Oval" #ENTER ACTUAL PATH RELATIVE
