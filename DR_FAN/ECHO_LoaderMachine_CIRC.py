...
from modulator_FAN_CIRC import build_circulant_matrix
from Phantom_generator_FAN_CIRC import perform_scan_on_phantoms
from CGAN_paper_ECHO_FAN_CIRC import Generator
import psutil, time
...
# Load model
generator_model_path = "Outputs\Circle" #ENTER ACTUAL PATH RELATIVE
